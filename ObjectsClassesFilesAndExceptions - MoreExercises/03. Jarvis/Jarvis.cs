...
public class Jarvis
{
    ...
    public static void Main()
    {
        ...
        while (true)
        {
            ...
            var energyConsumption = Math.Abs(int.Parse(robotComponents[1]));
            ...
            else if (typeOfComponent.Equals("Leg"))
            {
                ...
                else
                {
                    foreach (var l in legList)
                    {
                        ...
                        {
                            energyCapacity += (l.EnergyConsumption - leg.EnergyConsumption);
                            legList.Remove(l);
                            legList.Add(leg);
                            break;
                        }
            ...
            else
            {
                ...
                else
                {
                    foreach (var a in armList)
                    {
                        ...
                        {
                            energyCapacity += (a.EnergyConsumption - arm.EnergyConsumption);
                            armList.Remove(a);
                            armList.Add(arm);
                            break;
                        }
        ...
        else
        {
            ...
            foreach (var a in armList.OrderBy(x => x.EnergyConsumption))
            {
            ...
            foreach (var l in legList.OrderBy(x => x.EnergyConsumption))
            {
